                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="treeview"><a href="mohoncuti.html"><i class="fa fa-circle-o"></i> Sokong/Lulus Permohonan</a></li>
                                    </ul>
                                </li>
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview active">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="treeview active"><a href="daftarCuti.html"><i class="fa fa-circle-o"></i> Daftar Cuti</a></li>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Capai Cuti Umum</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- Borang mohon cuti -->
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <input type="text" class="form-control input-sm" rows="3" placeholder="Tahun, etc: 2016"/>
                                            </div>
                                            <div class="form-group">
                                                <select class="form-control input-sm" >
                                                    <option hidden value="">Sila pilih kampus...</option>
                                                    <option>Kuala Lumpur</option>
                                                    <option>Johor Bahru</option>
                                                    <option>Kuala Lumpur & Johor Bahru</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">CAPAI</button>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <legend>Daftar Cuti</legend>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label>Tarikh:</label>
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" class="form-control input-sm pull-right" id="datepicker" rows="3">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label>Kampus</label>
                                                    <select placeholder="Kampus" class="form-control">
                                                      <option>Kuala Lumpur</option>
                                                      <option>Johor Bahru</option>
                                                      <option>Kuala Lumpur & Johor Bahru</option>
                                                    </select>
                                        ...
                                        <div class="box-footer">                        
                                            ...
                                            <button type="submit" class="btn btn-info">Daftar Cuti</button>
                                        </div>
                                    </div>
                                </form>
                            </div><!-- /.box -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Senarai Permohonan Cuti Rehat</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                        <div class="row">
                                            <th class="col-sm-1">Bil</th>
                                            <th class="col-sm-1">Tarikh Cuti Umum</th>
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Hapus Cuti Umum</h4>
                                            </div>
