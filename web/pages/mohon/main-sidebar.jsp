<%-- 
    ...
    Created on : Dec 11, 2016, 1:28:20 PM
    Author     : USER
--%>
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<c:out value='${sessionScope.staffSession.photo}'/>" class="img-circle" width="160" height="160" alt="User Image">
            </div>
                ...
                <ul class="treeview-menu">
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="SejarahPermohonan"><i class="fa fa-circle-o"></i> Semak Permohonan</a></li>
